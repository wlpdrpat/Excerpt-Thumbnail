...
class Excerpt_Thumbnail_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $excerpt_thumbnail       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->excerpt_thumbnail, plugin_dir_url( __FILE__ ) . 'css/excerpt-thumbnail-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->excerpt_thumbnail, plugin_dir_url( __FILE__ ) . 'js/excerpt-thumbnail-public.js', array( 'jquery' ), $this->version, false );
